...
export default function HeroSection({ subtitle }: HeroSectionProps) {
  ...
  return (
    <section className="min-h-[60vh] flex items-center justify-center bg-gradient-to-br from-white via-blue-50/30 to-purple-50/30 pt-40 pb-12 relative overflow-hidden">
