...
// Load blog image manifest for local paths (generated by sync-blog-images.js)
...
try {
  ...
  // Manifest not available (dev mode or first build) - will use remote URLs
}
